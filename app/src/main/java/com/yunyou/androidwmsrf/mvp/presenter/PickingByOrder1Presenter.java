...
@ActivityScope
public class PickingByOrder1Presenter extends BasePresenter<PickingByOrder1Contract.Model, PickingByOrder1Contract.View> {
    @Inject
    ...
    @Inject
    public PickingByOrder1Presenter(PickingByOrder1Contract.Model model, PickingByOrder1Contract.View rootView) {
                ...
                .subscribe(new ErrorHandleSubscriber<QueryPickDetailResponse>(mErrorHandler) {
                    ...
                    public void onNext(QueryPickDetailResponse response) {
                        ...
                        if (response.isSuccess()) {
                            mRootView.goToPickingByOrder2Activity(response.getBody());
