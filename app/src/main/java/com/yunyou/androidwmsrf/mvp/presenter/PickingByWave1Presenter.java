...
@ActivityScope
public class PickingByWave1Presenter extends BasePresenter<PickingByWave1Contract.Model, PickingByWave1Contract.View> {
    @Inject
    ...
    @Inject
    public PickingByWave1Presenter(PickingByWave1Contract.Model model, PickingByWave1Contract.View rootView) {
                ...
                .subscribe(new ErrorHandleSubscriber<QueryPickDetailResponse>(mErrorHandler) {
                    ...
                    public void onNext(QueryPickDetailResponse response) {
                        ...
                        if (response.isSuccess()) {
                            mRootView.goToPickingByWave2Activity(response.getBody());
