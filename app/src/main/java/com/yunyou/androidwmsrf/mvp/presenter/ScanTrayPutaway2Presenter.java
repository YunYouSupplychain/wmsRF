...
@ActivityScope
public class ScanTrayPutaway2Presenter extends BasePresenter<ScanTrayPutaway2Contract.Model, ScanTrayPutaway2Contract.View> {
    @Inject
    ...
    @Inject
    public ScanTrayPutaway2Presenter(ScanTrayPutaway2Contract.Model model, ScanTrayPutaway2Contract.View rootView) {
