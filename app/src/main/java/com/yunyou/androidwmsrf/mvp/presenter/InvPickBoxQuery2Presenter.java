...
@ActivityScope
public class InvPickBoxQuery2Presenter extends BasePresenter<InvPickBoxQuery2Contract.Model, InvPickBoxQuery2Contract.View> {
    @Inject
    ...
    @Inject
    public InvPickBoxQuery2Presenter(InvPickBoxQuery2Contract.Model model, InvPickBoxQuery2Contract.View rootView) {
    ...
    public void queryPickBoxDetail(QueryPickBoxDetailRequest request) {
        mModel.queryPickBoxDetail(request)
                ...
                .subscribe(new ErrorHandleSubscriber<QueryPickBoxDetailResponse>(mErrorHandler) {
                    @Override
                    public void onNext(QueryPickBoxDetailResponse response) {
                        if (null == response) {
                        ...
                        if (response.isSuccess()) {
                            mRootView.goToInvPickBoxQuery3Activity(response.getBody());
