...
@ActivityScope
public class ScanSkuReceipt1Presenter extends BasePresenter<ScanSkuReceipt1Contract.Model, ScanSkuReceipt1Contract.View> {
    @Inject
    ...
    @Inject
    public ScanSkuReceipt1Presenter(ScanSkuReceipt1Contract.Model model, ScanSkuReceipt1Contract.View rootView) {
                ...
                .subscribe(new ErrorHandleSubscriber<CheckAsnIsPalletizeResponse>(mErrorHandler) {
                    ...
                    public void onNext(CheckAsnIsPalletizeResponse response) {
                        ...
                        if (response.isSuccess()) {
                            mRootView.goToScanSkuReceipt2Activity();
