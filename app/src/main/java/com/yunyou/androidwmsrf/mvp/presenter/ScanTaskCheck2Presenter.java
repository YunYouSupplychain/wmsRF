...
@ActivityScope
public class ScanTaskCheck2Presenter extends BasePresenter<ScanTaskCheck2Contract.Model, ScanTaskCheck2Contract.View> {
    @Inject
    ...
    @Inject
    public ScanTaskCheck2Presenter(ScanTaskCheck2Contract.Model model, ScanTaskCheck2Contract.View rootView) {
    ...
    public void queryTaskCountDetail(QueryTaskCountDetailRequest request) {
        mModel.queryTaskCountDetail(request)
                ...
                .subscribe(new ErrorHandleSubscriber<QueryTaskCountDetailResponse>(mErrorHandler) {
                    @Override
                    public void onNext(QueryTaskCountDetailResponse response) {
                        if (null == response) {
                        ...
                        if (response.isSuccess()) {
                            mRootView.goToScanTaskCheck3Activity(response.getBody());
