...
@ActivityScope
public class StandardMovePresenter extends BasePresenter<StandardMoveContract.Model, StandardMoveContract.View> {
    @Inject
    ...
    @Inject
    public StandardMovePresenter(StandardMoveContract.Model model, StandardMoveContract.View rootView) {
