...
@ActivityScope
public class ScanTaskPutaway1Presenter extends BasePresenter<ScanTaskPutaway1Contract.Model, ScanTaskPutaway1Contract.View> {
    @Inject
    ...
    @Inject
    public ScanTaskPutaway1Presenter(ScanTaskPutaway1Contract.Model model, ScanTaskPutaway1Contract.View rootView) {
                ...
                .subscribe(new ErrorHandleSubscriber<QueryPutAwayTaskByTaskNoResponse>(mErrorHandler) {
                    ...
                    public void onNext(QueryPutAwayTaskByTaskNoResponse response) {
                        ...
                        if (response.isSuccess()) {
                            mRootView.goToScanTaskPutaway2Activity(response.getBody());
