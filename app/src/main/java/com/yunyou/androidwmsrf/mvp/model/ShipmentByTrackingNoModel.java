...
@ActivityScope
public class ShipmentByTrackingNoModel extends BaseModel implements ShipmentByTrackingNoContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public ShipmentByTrackingNoModel(IRepositoryManager repositoryManager) {
