...
@ActivityScope
public class PickingByOrder2Presenter extends BasePresenter<PickingByOrder2Contract.Model, PickingByOrder2Contract.View> {
    @Inject
    ...
    @Inject
    public PickingByOrder2Presenter(PickingByOrder2Contract.Model model, PickingByOrder2Contract.View rootView) {
    ...
    public void savePick(SavePickRequest request) {
        mModel.savePick(request)
                ...
                .subscribe(new ErrorHandleSubscriber<SavePickResponse>(mErrorHandler) {
                    @Override
                    public void onNext(SavePickResponse response) {
                        if (null == response) {
