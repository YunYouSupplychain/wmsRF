...
import com.yunyou.androidwmsrf.di.component.DaggerPickingByManual1Component;
...
import com.yunyou.androidwmsrf.mvp.presenter.PickingByManual1Presenter;
 ...
 * @version 2019/10/09
 */
public class PickingByManual1Activity extends BaseActivity<PickingByManual1Presenter> implements PickingByManual1Contract.View, IToolbar {
    ...
    public void setupActivityComponent(@NonNull AppComponent appComponent) {
        // 如找不到该类,请编译一下项目
        DaggerPickingByManual1Component
                .builder()
                .appComponent(appComponent)
                .pickingByManual1Module(new PickingByManual1Module(this))
                .build()
                .inject(this);
    }
    ...
    public int initView(@Nullable Bundle savedInstanceState) {
        ...
        return R.layout.activity_picking_by_manual1;
    }
    ...
    @Override
    public void goToPickingByManual2Activity(PickDetailInfo info) {
        Intent intent = new Intent(PickingByManual1Activity.this, PickingByManual2Activity.class);
    ...
    public void onBackPressed() {
        launchActivity(new Intent(PickingByManual1Activity.this, PickingActivity.class));
    }
}