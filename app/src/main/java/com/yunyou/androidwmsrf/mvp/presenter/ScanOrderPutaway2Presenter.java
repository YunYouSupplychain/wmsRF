...
@ActivityScope
public class ScanOrderPutaway2Presenter extends BasePresenter<ScanOrderPutaway2Contract.Model, ScanOrderPutaway2Contract.View> {
    @Inject
    ...
    @Inject
    public ScanOrderPutaway2Presenter(ScanOrderPutaway2Contract.Model model, ScanOrderPutaway2Contract.View rootView) {
    ...
    public void savePutAwayByTask(SavePutAwayByTaskRequest request) {
        mModel.savePutAwayByTask(request)
                ...
                .subscribe(new ErrorHandleSubscriber<SavePutAwayByTaskResponse>(mErrorHandler) {
                    @Override
                    public void onNext(SavePutAwayByTaskResponse response) {
                        if (null == response) {
