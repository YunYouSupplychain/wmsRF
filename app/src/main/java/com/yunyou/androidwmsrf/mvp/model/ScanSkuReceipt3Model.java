...
@ActivityScope
public class ScanSkuReceipt3Model extends BaseModel implements ScanSkuReceipt3Contract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public ScanSkuReceipt3Model(IRepositoryManager repositoryManager) {
