...
@ActivityScope
public class ScanTaskCheck1Presenter extends BasePresenter<ScanTaskCheck1Contract.Model, ScanTaskCheck1Contract.View> {
    @Inject
    ...
    @Inject
    public ScanTaskCheck1Presenter(ScanTaskCheck1Contract.Model model, ScanTaskCheck1Contract.View rootView) {
    ...
    public void checkTaskCount(CheckTaskCountRequest request) {
        mModel.checkTaskCount(request)
                ...
                .subscribe(new ErrorHandleSubscriber<CheckTaskCountResponse>(mErrorHandler) {
                    @Override
                    public void onNext(CheckTaskCountResponse response) {
                        if (null == response) {
                        ...
                        if (response.isSuccess()) {
                            mRootView.goToScanTaskCheck2Activity();
