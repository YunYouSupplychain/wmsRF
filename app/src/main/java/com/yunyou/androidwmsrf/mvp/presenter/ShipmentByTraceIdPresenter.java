...
@ActivityScope
public class ShipmentByTraceIdPresenter extends BasePresenter<ShipmentByTraceIdContract.Model, ShipmentByTraceIdContract.View> {
    @Inject
    ...
    @Inject
    public ShipmentByTraceIdPresenter(ShipmentByTraceIdContract.Model model, ShipmentByTraceIdContract.View rootView) {
