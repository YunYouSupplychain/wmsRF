...
@ActivityScope
public class ReceiptLotAttPresenter extends BasePresenter<ReceiptLotAttContract.Model, ReceiptLotAttContract.View> {
    @Inject
    ...
    @Inject
    public ReceiptLotAttPresenter(ReceiptLotAttContract.Model model, ReceiptLotAttContract.View rootView) {
