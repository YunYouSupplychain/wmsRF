...
@ActivityScope
public class InvPickBoxQuery1Presenter extends BasePresenter<InvPickBoxQuery1Contract.Model, InvPickBoxQuery1Contract.View> {
    @Inject
    ...
    @Inject
    public InvPickBoxQuery1Presenter(InvPickBoxQuery1Contract.Model model, InvPickBoxQuery1Contract.View rootView) {
    ...
    public void queryPickBoxHeader(QueryPickBoxHeaderRequest request) {
        mModel.queryPickBoxHeader(request)
                ...
                .subscribe(new ErrorHandleSubscriber<QueryPickBoxHeaderResponse>(mErrorHandler) {
                    @Override
                    public void onNext(QueryPickBoxHeaderResponse response) {
                        if (null == response) {
                        ...
                        if (response.isSuccess()) {
                            mRootView.goToInvPickBoxQuery2Activity(response.getBody());
