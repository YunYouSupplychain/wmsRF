...
@ActivityScope
public class WholeLocMovePresenter extends BasePresenter<WholeLocMoveContract.Model, WholeLocMoveContract.View> {
    @Inject
    ...
    @Inject
    public WholeLocMovePresenter(WholeLocMoveContract.Model model, WholeLocMoveContract.View rootView) {
