...
@ActivityScope
public class ScanOrderPutaway2Model extends BaseModel implements ScanOrderPutaway2Contract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public ScanOrderPutaway2Model(IRepositoryManager repositoryManager) {
