...
@ActivityScope
public class ScanOrderPutaway1Model extends BaseModel implements ScanOrderPutaway1Contract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public ScanOrderPutaway1Model(IRepositoryManager repositoryManager) {
    ...
    @Override
    public Observable<QueryPutAwayTaskByTaskNoResponse> queryPutAwayTaskByTaskNo(QueryPutAwayTaskByTaskNoRequest requestEnvelope) {
        return Observable.just(mRepositoryManager
                .obtainRetrofitService(CommonService.class)
                .queryPutAwayTaskByTaskNo(requestEnvelope))
                // 不使用缓存
