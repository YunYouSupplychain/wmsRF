...
@ActivityScope
public class ScanTaskCheck6Presenter extends BasePresenter<ScanTaskCheck6Contract.Model, ScanTaskCheck6Contract.View> {
    @Inject
    ...
    @Inject
    public ScanTaskCheck6Presenter(ScanTaskCheck6Contract.Model model, ScanTaskCheck6Contract.View rootView) {
    ...
    public void addNewTaskCount(AddNewTaskCountRequest request) {
        mModel.addNewTaskCount(request)
                ...
                .subscribe(new ErrorHandleSubscriber<AddNewTaskCountResponse>(mErrorHandler) {
                    @Override
                    public void onNext(AddNewTaskCountResponse response) {
                        if (null == response) {
