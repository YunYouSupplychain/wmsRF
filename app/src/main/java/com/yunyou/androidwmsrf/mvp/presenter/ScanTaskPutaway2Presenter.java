...
@ActivityScope
public class ScanTaskPutaway2Presenter extends BasePresenter<ScanTaskPutaway2Contract.Model, ScanTaskPutaway2Contract.View> {
    @Inject
    ...
    @Inject
    public ScanTaskPutaway2Presenter(ScanTaskPutaway2Contract.Model model, ScanTaskPutaway2Contract.View rootView) {
