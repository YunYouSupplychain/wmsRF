...
@ActivityScope
public class ShipmentByTrackingNoPresenter extends BasePresenter<ShipmentByTrackingNoContract.Model, ShipmentByTrackingNoContract.View> {
    @Inject
    ...
    @Inject
    public ShipmentByTrackingNoPresenter(ShipmentByTrackingNoContract.Model model, ShipmentByTrackingNoContract.View rootView) {
