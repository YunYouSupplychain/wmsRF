...
@ActivityScope
public class ScanTrayReceipt3Presenter extends BasePresenter<ScanTrayReceipt3Contract.Model, ScanTrayReceipt3Contract.View> {
    @Inject
    ...
    @Inject
    public ScanTrayReceipt3Presenter(ScanTrayReceipt3Contract.Model model, ScanTrayReceipt3Contract.View rootView) {
