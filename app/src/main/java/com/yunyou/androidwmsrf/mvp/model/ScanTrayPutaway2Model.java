...
@ActivityScope
public class ScanTrayPutaway2Model extends BaseModel implements ScanTrayPutaway2Contract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public ScanTrayPutaway2Model(IRepositoryManager repositoryManager) {
